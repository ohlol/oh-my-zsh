# https://raw.githubusercontent.com/tnwinc/omz-git/master/omz-git.plugin.zsh
...
PROMPT='%{$fg[cyan]%}%n%{$reset_color%}@%{$fg[yellow]%}%m%{$reset_color%}:%{$fg[cyan]%}%c%{$reset_color%}$(git_prompt_info)%% '
